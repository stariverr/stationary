...
<template>
    <Dialog :open="open" @update:open="emit('update:open', $event)">
        <DialogContent class="sm:max-w-[600px] max-h-[80vh] flex flex-col p-6 bg-white rounded-lg">
            ...
            <div class="flex-1 overflow-y-auto py-4 min-h-0 divide-y divide-zinc-50 scrollbar-thin">
                ...
                <template v-else>
                    <div
                        v-for="orphan in orphanMediaList"
                        :key="orphan.id"
                    ...
                    >
                        <div class="flex items-center gap-3 min-w-0">
                            ...
                            />
                            <div class="w-10 h-10 bg-zinc-100 rounded-md overflow-hidden flex-shrink-0 flex items-center justify-center">
                                <img
