...
import { Info, Tag, Calendar, User, FileImage, Globe, Link as LinkIcon, X, Check, Edit3, Loader2 } from "@lucide/vue";
        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-6">
            <div class="space-y-4">
                <div class="flex items-start justify-between gap-4">
                    <h1 v-if="!isEditing" class="text-xl font-bold text-gray-900 leading-tight flex-1">
                        {{ post.title }}
                    </h1>
                    ...
                    <button
                        v-if="!isEditing"
                        @click="startEditing"
                        class="px-2.5 py-1.5 text-xs font-semibold text-indigo-600 bg-indigo-55 hover:bg-indigo-100 border border-indigo-100 rounded-md transition-all shrink-0 cursor-pointer flex items-center gap-1"
                    >
