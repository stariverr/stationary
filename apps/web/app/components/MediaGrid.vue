    ...
    <div class="flex-1 min-h-0 flex flex-col bg-white overflow-hidden relative">
        ...
        <div class="h-14 border-b border-gray-100 flex items-center justify-between px-6 shrink-0">
            ...
            <div class="flex items-center gap-2 bg-gray-100 p-1 rounded-lg">
                ...
                <!-- Display Mode Toggle -->
                <button @click="displayMode = 'flat'" :class="displayMode === 'flat' ? 'bg-white shadow-sm text-blue-600' : 'text-gray-500 hover:text-gray-700'" class="p-1.5 rounded-md transition-all flex items-center gap-1 text-sm font-medium">
                    <LayoutGrid class="w-4 h-4" /> Flat
                </button>
                <button @click="displayMode = 'stacked'" :class="displayMode === 'stacked' ? 'bg-white shadow-sm text-blue-600' : 'text-gray-500 hover:text-gray-700'" class="p-1.5 rounded-md transition-all flex items-center gap-1 text-sm font-medium">
                    <Layers class="w-4 h-4" /> Stacked
                </button>
            </div>
        </div>
